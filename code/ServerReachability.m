...
+ (BOOL) hostAvailable: (NSString*) theHost {
	NSString *addressString = [ServerReachability getIPAddressForHost:theHost];
	if (!addressString) {
	...
	BOOL gotAddress = [ServerReachability addressFromString:addressString address:&address];
	if (!gotAddress) {
